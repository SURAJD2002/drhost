-- Manual RPC Function Setup for Nearby Products
...
-- Test with sample coordinates (replace with your test coordinates)
SELECT * FROM public.get_nearby_products(23.7407, 86.4146) LIMIT 5;
