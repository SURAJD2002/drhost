-- Update get_related_products_nearby to use product coordinates instead of seller coordinates
-- This ensures we show truly nearby products based on product location
