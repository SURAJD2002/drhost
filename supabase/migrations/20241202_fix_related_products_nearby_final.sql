-- Final fix for get_related_products_nearby() function
-- Drop any existing function with this name to start fresh
DROP FUNCTION IF EXISTS public.get_related_products_nearby CASCADE;

-- Create the function with the correct signature that matches the JavaScript call
