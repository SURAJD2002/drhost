-- Fix ambiguous category_id column reference in get_related_products_nearby function
-- The error occurs because both products and current_product have category_id columns
...
BEGIN
  ...
  WHERE p.category_id = current_category_id  -- Use the variable instead of ambiguous reference
