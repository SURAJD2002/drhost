...
//   return (
//     <div className="auth">
//       <h1 style={{ color: '#007bff' }}>{isSignUp ? 'Sign Up' : 'Login'}</h1>
//       <button 
...
//         <button type="submit" disabled={loading || (isSignUp && (!email && !phone) || (phone && !showOtp))}>
...
//       </button>
//       <Link to="/" className="back-link" style={{ color: '#007bff' }}>Back to Home</Link>
//     </div>
//   );
// }
...
//           return;
//         }
//         // If session is refreshed, navigate to home or account
//         navigate('/');
//       }
//     };
//     checkSession();
